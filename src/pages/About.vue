...
<template>
  <div
    class="flex flex-col h-screen bg-gradient-to-br from-gray-100 to-blue-50 dark:from-gray-900 dark:to-blue-900 p-6 overflow-hidden select-none"
  >
    <div class="container mx-auto max-w-4xl h-full overflow-y-auto scrollbar-hide pb-6">
      ...
      <div class="mb-8 animate-fade-in-down text-center">
        <div class="relative inline-block">
          <h2
            class="text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600"
          >
            {{ $t('about.title') }}
          </h2>
          <div
            class="absolute -bottom-2 left-1/2 transform -translate-x-1/2 h-1 w-20 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full"
          ></div>
        </div>
      </div>
      ...
      <div class="flex flex-col gap-8">
        ...
        <div
          class="w-full transform hover:scale-105 transition-all duration-300 animate-fade-in-up delay-100"
        >
          <div
            class="bg-white dark:bg-gray-800 backdrop-blur-md bg-opacity-80 dark:bg-opacity-80 shadow-lg rounded-2xl p-6 border border-gray-200 dark:border-gray-700 relative overflow-hidden"
          >
            <div
              class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-blue-400 to-transparent opacity-20 rounded-full -mr-16 -mt-16"
            ></div>
            ...
            <div class="space-y-6 relative z-10">
              <div
                class="flex items-center transform hover:translate-x-2 transition-transform duration-300"
              >
                ...
                <div>
                  ...
                  <p class="text-lg font-semibold text-gray-900 dark:text-white select-text">
                    {{ ver }}
                  </p>
                </div>
              </div>
              ...
              <div class="flex justify-center mt-4 w-full">
                ...
                >
                  ...
                  <span>{{
                    isCopied ? t('about.environment.success') : t('about.environment.copy')
                  }}</span>
                </button>
              </div>
            </div>
        ...
        <!-- Contributors Card -->
        <div
          class="w-full transform hover:scale-105 transition-all duration-300 animate-fade-in-up delay-200"
        >
          <div
            class="bg-white dark:bg-gray-800 backdrop-blur-md bg-opacity-80 dark:bg-opacity-80 shadow-lg rounded-2xl p-6 border border-gray-200 dark:border-gray-700 relative overflow-hidden"
          >
            <div
              class="absolute bottom-0 left-0 w-40 h-40 bg-gradient-to-tr from-purple-400 to-transparent opacity-20 rounded-full -ml-20 -mb-20"
            ></div>
            ...
            <ul class="space-y-4 relative z-10">
              ...
              >
                <div class="flex items-center">
                  <div
                    class="w-12 h-12 rounded-full overflow-hidden shadow-lg group-hover:shadow-xl group-hover:ring-2 ring-blue-500"
                  >
                    <img
                  ...
                  <div class="ml-4 flex-grow">
                    <a
                      ...
                      target="_blank"
                      class="text-blue-600 dark:text-blue-400 hover:text-purple-600 dark:hover:text-purple-400 font-semibold text-lg transition-colors duration-300"
                      >{{ developer.name }}</a
                    >
        ...
        <!-- Tech Stack Card -->
        <div
          class="w-full transform hover:scale-105 transition-all duration-300 animate-fade-in-up delay-300"
        >
          <div
            class="bg-white dark:bg-gray-800 backdrop-blur-md bg-opacity-80 dark:bg-opacity-80 shadow-lg rounded-2xl p-6 border border-gray-200 dark:border-gray-700 relative overflow-hidden"
          >
            ...
            ></div>
            <div
              class="absolute bottom-0 right-0 w-40 h-40 bg-gradient-to-bl from-pink-400 to-transparent opacity-20 rounded-full -mr-20 -mb-20"
            ></div>
                ...
                <div class="flex flex-col justify-between h-full">
                  <div class="flex flex-col">
                    <div class="flex items-center justify-center mb-4">
                      <div
                        class="w-16 h-16 flex items-center justify-center bg-white dark:bg-gray-700 rounded-full transform group-hover:rotate-12 transition-transform duration-500 shadow-lg p-2 border border-gray-200 dark:border-gray-600"
                      >
                        <img
                          :src="tech.logo"
                          :alt="`${tech.name} logo`"
                    ...
                    <h4
                      class="text-xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600 mb-2"
                    >
                      {{ tech.name }}
                    </h4>
                  ...
                  <div class="text-center">
                    <a
                      :href="tech.url"
                      target="_blank"
                      class="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium text-sm hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300"
                    >
                      访问官网
      ...
      <div
        class="mt-8 text-center text-gray-600 dark:text-gray-400 text-sm animate-fade-in-up delay-500"
      >
        <div class="mb-2">
